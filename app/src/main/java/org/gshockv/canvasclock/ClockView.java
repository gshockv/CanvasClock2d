package org.gshockv.canvasclock;
...
public class ClockView extends View {
    ...
    private void initClock() {
        drawBgColor = getResources().getColor(R.color.colorPrimary);
        drawClockColor = getResources().getColor(R.color.colorAccent);
